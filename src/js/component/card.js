        ...
        <>
            ...
            <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <button onClick={() => actions.handleFav(store.favourites.some((value) => item.name === value), item)} className="fav-btn rounded px-3">
                        <i className={(store.favourites.some((value) => item.name === value) ? "fa-solid" : "fa-regular") + " fa-heart"}></i>
                    </button>
                </div>
            </div>
        </>
